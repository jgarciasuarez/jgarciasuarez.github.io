...
| Research software and reproducibility | Weak | Computational methods are described conceptually, but the documented `soft-contact` Python repository is not exposed. | High | Add a small “Software & data” block linking `soft-contact`, the DDCF dataset, and future verified repositories. |
