        ...
        <aside className={styles.sideCol}>
            ...
            <div className={styles.timeline}>
              ...
              <div className={styles.timelineItem}>
                ...
                <div className={styles.timelineContent}>
                  ...
                  <h4 className={styles.timelineRole}>Primary Instructor</h4>
              ...
              <div className={styles.timelineItem}>
                <div className={styles.timelineDot} />
                <div className={styles.timelineContent}>
                  <span className={styles.timelineDate}>Spring 2021-2024</span>
                  <h4 className={styles.timelineRole}>Co-Instructor / Lecturer</h4>
                  <p className={styles.timelineCourse}>CIVIL-422: Advanced Continuum Mechanics</p>
                  <p className={styles.timelineLocation}>EPFL</p>
                </div>
              </div>
              ...
              <div className={styles.timelineItem}>
                ...
                <div className={styles.timelineContent}>
                  ...
                  <span className={styles.awardBadge}>🏆 Best TA Distinction (Fall 2017)</span>
                </div>
              </div>
          ...
          <div className={styles.glassPanel}>
            ...
            <ul className={styles.mentorshipList}>
              <li>
                <span className={styles.mentorNumber}>1</span>
                <span className={styles.mentorLabel}>PhD Student (Candidacy passed Oct 2025)</span>
              </li>
              <li>
              ...
              <li>
                <span className={styles.mentorNumber}>10</span>
                <span className={styles.mentorLabel}>Semester Projects (Bachelor/Master)</span>
              </li>
            </ul>
          </div>
