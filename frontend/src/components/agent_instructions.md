...
| StatsRibbon | `StatsRibbon.tsx` | `StatsRibbon.module.css` | No | 4-column grid showing key metrics (24 publications, ~1M CHF grant, Ph.D. Caltech 2020, 3 research themes). |
